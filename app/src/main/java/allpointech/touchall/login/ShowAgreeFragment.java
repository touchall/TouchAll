package allpointech.touchall.login;
...
import allpointech.touchall.network.http.resource.data.ResConsignment;
import allpointech.touchall.network.http.resource.data.ResFind;
import allpointech.touchall.network.http.resource.data.ResPositionAgree;
import allpointech.touchall.network.http.resource.data.ResTerms;
