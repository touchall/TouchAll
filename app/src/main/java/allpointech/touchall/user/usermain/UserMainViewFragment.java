...
import allpointech.touchall.network.http.TNHttpMultiPartTaskEx;
...
import allpointech.touchall.network.http.resource.data.ResCode;
import allpointech.touchall.network.http.resource.data.ResInfo;
...
public class UserMainViewFragment extends BaseFragment implements View.OnClickListener, BaseAppCompatActivity.onKeyBackPressedListener, TNHttpMultiPartTask.onHttpNetResultListener, TNHttpMultiPartTaskEx.onHttpNetResultListener, TNHttpMultiPartTask.onHttpNetFailResultListener {
    ...
    private LinearLayout mBtnIntro;
    private LinearLayout mBtnFindStore;
    private LinearLayout mBtnChecUsekMyPoint;
    private LinearLayout mBtnMyPage;
    private LinearLayout mBtnEvent;
    private LinearLayout mBtnCustomer;
...
//        mBtnEvent.setOnClickListener(this);
        ...
        mBtnIntro = (LinearLayout) view.findViewById(R.id.btn_intro);
        mBtnIntro.setOnClickListener(this);
        mBtnFindStore = (LinearLayout) view.findViewById(R.id.btn_find_store);
        mBtnFindStore.setOnClickListener(this);
        mBtnChecUsekMyPoint = (LinearLayout) view.findViewById(R.id.btn_check_use_mypoint);
        mBtnChecUsekMyPoint.setOnClickListener(this);
        mBtnMyPage = (LinearLayout) view.findViewById(R.id.btn_mypage);
        mBtnMyPage.setOnClickListener(this);
        mBtnEvent = (LinearLayout) view.findViewById(R.id.btn_event);
        mBtnEvent.setOnClickListener(this);
        mBtnCustomer = (LinearLayout) view.findViewById(R.id.btn_cusomer);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.button_canuse_point: {
                ...
                mBtnCanusePoint.setChecked(true);
