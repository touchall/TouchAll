...
import allpointech.touchall.dialog.MsgEvaluationDialog;
import allpointech.touchall.dialog.MsgReceiptDialog;
...
import allpointech.touchall.network.http.resource.data.ResFindMyPoint;
import allpointech.touchall.network.http.resource.data.ResReqMyPointList;
import allpointech.touchall.network.http.resource.data.ResReqPoint;
import allpointech.touchall.network.http.resource.data.ResSector;
import allpointech.touchall.network.http.resource.data.ResSubCitys;
import allpointech.touchall.network.http.resource.data.ResSubSector;
...
public class CheckMyPointListFragment extends BaseFragment implements TNHttpMultiPartTask.onHttpNetResultListener, CheckMyPointAdapter.OnMyPointClickListener, SwipeRefreshLayout.OnRefreshListener, View.OnClickListener {
    ...
    private LinearLayout mLiPointKindTotal;
    private LinearLayout mLiPointKindGroup;
    private LinearLayout mLiPointKindSingle;

    private TextView mTvHeaderStempTotal;
    private TextView mTvHeaderStempCanuse;
    private LinearLayout mLiStampKindTotal;
    private LinearLayout mLiStampKindGroup;
    private LinearLayout mLiStampKindSingle;

    private TextView mTvHeaderGameTotal;
    private TextView mTvHeaderGameCanuse;
    private LinearLayout mLiGameKindTotal;
    private LinearLayout mLiGameKindGroup;
    private LinearLayout mLiGameKindSingle;

    private boolean mMyPointExpendOn = false;
    private LinearLayout mBtnMyPointExpendToggle;
    private ImageView mIvExpendArraw;
...
//                    }
        ...
        mLiPointKindTotal = (LinearLayout) view.findViewById(R.id.li_mypoint_point_detail_kind_total);
        mLiPointKindTotal.setVisibility(View.GONE);
        mLiPointKindGroup = (LinearLayout) view.findViewById(R.id.li_mypoint_point_detail_kind_group);
        mLiPointKindGroup.setVisibility(View.GONE);
        mLiPointKindSingle = (LinearLayout) view.findViewById(R.id.li_mypoint_point_detail_kind_single);
        mLiPointKindSingle.setVisibility(View.GONE);
        ...
        mLiStampKindTotal = (LinearLayout) view.findViewById(R.id.li_mypoint_stamp_detail_kind_total);
        mLiStampKindTotal.setVisibility(View.GONE);
        mLiStampKindGroup = (LinearLayout) view.findViewById(R.id.li_mypoint_stamp_detail_kind_group);
        mLiStampKindGroup.setVisibility(View.GONE);
        mLiStampKindSingle = (LinearLayout) view.findViewById(R.id.li_mypoint_stamp_detail_kind_single);
        mLiStampKindSingle.setVisibility(View.GONE);
        ...
        mLiGameKindTotal = (LinearLayout) view.findViewById(R.id.li_mypoint_game_detail_kind_total);
        mLiGameKindTotal.setVisibility(View.GONE);
        mLiGameKindGroup = (LinearLayout) view.findViewById(R.id.li_mypoint_game_detail_kind_group);
        mLiGameKindGroup.setVisibility(View.GONE);
        mLiGameKindSingle = (LinearLayout) view.findViewById(R.id.li_mypoint_game_detail_kind_single);
        mLiGameKindSingle.setVisibility(View.GONE);

        mBtnMyPointExpendToggle = (LinearLayout) view.findViewById(R.id.btn_mypoint_expend_toggle);
        mBtnMyPointExpendToggle.setOnClickListener(this);
        mIvExpendArraw = (ImageView) view.findViewById(R.id.iv_mypoint_expend_arrow);
...
//                        mDataList.add(i, new JSONObject());
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_mypoint_expend_toggle:
            {
                if (mMyPointExpendOn == false) {
                    mIvExpendArraw.setImageResource(R.drawable.ic_up_arrow);
                    mLiPointKindTotal.setVisibility(View.VISIBLE);
                    mLiPointKindGroup.setVisibility(View.VISIBLE);
                    mLiPointKindSingle.setVisibility(View.VISIBLE);
                    mLiStampKindTotal.setVisibility(View.VISIBLE);
                    mLiStampKindGroup.setVisibility(View.VISIBLE);
                    mLiStampKindSingle.setVisibility(View.VISIBLE);
                    mLiGameKindTotal.setVisibility(View.VISIBLE);
                    mLiGameKindGroup.setVisibility(View.VISIBLE);
                    mLiGameKindSingle.setVisibility(View.VISIBLE);
                    mMyPointExpendOn = true;
                }
                else {
                    mIvExpendArraw.setImageResource(R.drawable.ic_down_arrow);
                    mLiPointKindTotal.setVisibility(View.GONE);
                    mLiPointKindGroup.setVisibility(View.GONE);
                    mLiPointKindSingle.setVisibility(View.GONE);
                    mLiStampKindTotal.setVisibility(View.GONE);
...
//        {
//            JSONObject row_data = mDataList.get(itemPosition-1);
//            if (row_data != null) {
...
//
//                final MsgReceiptDialog dialog = new MsgReceiptDialog();
//                Bundle b = new Bundle();
...
//        }
    ...
    @Override
    public void onPayCostClick(int position) {
...
//                        }
    ...
    public void onPointClick(int position) {
        ...
        if (row_data != null) {
            ...
            final MsgEvaluationDialog dialog = new MsgEvaluationDialog();
            Bundle b = new Bundle();
            b.putString("dialog_msg", getResources().getString(R.string.msg_logout));
            dialog.setArguments(b);
            dialog.setOnResultListener(new BaseDialogFragment.OnResultListener() {
