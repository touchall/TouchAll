...
import allpointech.touchall.network.http.resource.data.ResReqFranchiseePoint;
...
public class CheckFranchiseeFragment extends BaseFragment implements View.OnClickListener, BaseAppCompatActivity.onKeyBackPressedListener, TNHttpMultiPartTask.onHttpNetResultListener {
    ...
    private TextView mTvFranchiseeTitle;
...
//                    mActivity._disableNdef();
    ...
    protected void initLayout(View view) {
        ...
        mTvFranchiseeTitle = (TextView) view.findViewById(R.id.tv_mypoint_nfc_franchisee);
...
//        res.setParameterSerial(device_serial);
    ...
    protected void initRequest() {
        ...
        requestFranchiseePoint(mJunmun.substring(1));
    }
        ...
        if (o[0] instanceof ResReqTelegram) {
            ...
            if (JSONParser.isSuccess(obj)) {
                ...
                if (obj_message != null) {
                    ...
                    String storeType = "";
                    if (mStoreType.compareTo("T") == 0)
                        storeType = "통합형";
                    else if (mStoreType.compareTo("G") == 0)
                        storeType = "그룹형";
                    else if (mStoreType.compareTo("S") == 0)
                        storeType = "독립형";
                    mTvFranchiseeTitle.setText(mStoreName + "(" + storeType + ")");
